...
<script>
 ...
 //        var info = tablee.page.info();
    ...
    function addRow(){
        console.log('asd');
                    var checkbox = "<td style='width:5%''><input type='checkbox' id='check' name='checkbox[]'class='styled'></td>";
                    
                    var type = "<td>1</td>";
                    var date = "<td>2</td>";
                    	  var action = "<td class='text-center'><a href='CCDO_ViewMessage.php'><i class='icon-mail-read'></i> Open </a></li>";
                   
                    table.row.add([checkbox,'asd',type,date, action]).draw(false);
    } 
    realTime(); 
