...
<html>
  ...
  <body class="plain error-page-wrapper background-color background-image" style="background-image: url('assets/images/backgrounds/swirl_pattern.png');">
	...
	<div class="buttons-container">
		<a class="border-button" href="#" target="_blank">Go Back To Homepage</a>
	</div>
</div>
