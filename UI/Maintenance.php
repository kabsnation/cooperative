...
<html>
  ...
  <body class="plain error-page-wrapper background-color background-image" style="background-image: url('assets/images/backgrounds/memphis-colorful.png');">
    ...
    <p>
      Sorry for the inconvenience. <br> We'll be back up and running as fast as possible.
    </p>
	</div>
